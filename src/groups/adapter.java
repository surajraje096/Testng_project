...
import groups.errorcollector.ErrorCollector;


public class adapter implements IInvokedMethodListener {
	...
	public void afterInvocation(IInvokedMethod method, ITestResult result) {
		...
		if (method.isTestMethod()) {
			...
			List<Throwable> verificationFailures = collector.getVerificationFailures();
